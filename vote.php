        ...
        <div class="container nav-wrapper">
            <div class="logo">
                <?php if ($settings['logo_path'] && $settings['logo_path'] !== 'media/Logo_PD_IPM.png'): ?>
                    <img src="<?= htmlspecialchars($settings['logo_path']) ?>" alt="Logo" style="height: 80px; width: auto; margin-right: 10px;">
                <?php else: ?>
    ...
    <main class="container" style="padding-bottom: 5rem;">
        <div class="text-center mb-4" style="margin-top: 2rem;">
            ...
            <p style="color: #6b7280;">Silakan pilih
                <span id="rule-text" style="font-weight: bold; color: var(--accent-color);">
                ...
                <?php foreach ($candidates as $c): ?>
                    <div class="candidate-card" id="card-<?= $c['id'] ?>" onclick="toggleSelection(<?= $c['id'] ?>)">
                        ...
                        <div class="candidate-img-wrapper">
                            <img src="<?= htmlspecialchars($c['photo']) ?>" class="candidate-img" loading="lazy" decoding="async">
                        </div>
